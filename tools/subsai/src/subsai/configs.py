...
AVAILABLE_CHANNELS = {
    'CBS.us': {
        'description': 'CBS News is a US news channel that operates all over United States',
        'country': 'US',
        'url': 'https://cbsn-us.cbsnstream.cbsnews.com/out/v1/55a8648e8f134e82a470f83d562deeca/master.m3u8',
        'epg': '',
        'icon': 'assets/images/CBS_logo.svg.webp'
    }, 
    'cnn.us': {
        'description': 'CNN is a Internacional news channel that operates all over the world',
        'country': 'US',
        'url': 'https://turnerlive.warnermediacdn.com/hls/live/586495/cnngo/cnn_slate/VIDEO_0_3564000.m3u8',
        'epg': '',
        'icon': 'assets/images/CNN.svg.webp'
    },
