...
from subsai.configs import AVAILABLE_MODELS , AVAILABLE_CHANNELS 
...
class SubsAI:
    ...
    def available_channels() -> list:
        """
        Returns the curated list of channels
    ...
    def get_channel_info(channel_name: str) -> dict:
        """
        Returns general info about the channel

        :param channel_name: channel key name
